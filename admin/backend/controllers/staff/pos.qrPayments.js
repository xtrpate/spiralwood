...
const normalizeDeliveryForHash = (delivery, coords) => {
  if (!delivery) return null;
  return {
    address: normalizeText(delivery.address),
    requested_date: normalizeText(
...
exports.createAttempt = async (req, res) => {
  ...
  const normalizedDeliveryForHash = normalizeDeliveryForHash(delivery, deliveryCoords);
